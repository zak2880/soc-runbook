...
**Platform:** Microsoft Sentinel — via the Microsoft Defender XDR data connector. Time column is `TimeGenerated`. See [kql/xdr/network/dns-tunnelling.md](../../xdr/network/dns-tunnelling.md) for the XDR version  
