...
**Tables:** DeviceEvents  
**Platform:** Microsoft Defender XDR Advanced Hunting (native). Time column is `Timestamp`. See [kql/sentinel/identity/lsass-access-credential-dump.md](../../sentinel/identity/lsass-access-credential-dump.md) for the Sentinel version  
