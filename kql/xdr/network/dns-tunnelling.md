...
**Platform:** Microsoft Defender XDR Advanced Hunting (native). Time column is `Timestamp`. See [kql/sentinel/network/dns-tunnelling.md](../../sentinel/network/dns-tunnelling.md) for the Sentinel version  
