...
**Platform:** Microsoft Defender XDR Advanced Hunting (native). Time column is `Timestamp`. See [docs/reference/sentinel-vs-advanced-hunting.md](../../../docs/reference/sentinel-vs-advanced-hunting.md) for the Sentinel equivalent (`TimeGenerated`), at [kql/sentinel/process/lolbin-sweep.md](../../sentinel/process/lolbin-sweep.md)  
